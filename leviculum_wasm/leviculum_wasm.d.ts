...
export class ReticulumNode {
    ...
    deregisterRequestHandler(destination_hash: Uint8Array, path: string): boolean;
...
export interface InitOutput {
    ...
    readonly reticulumnode_deregisterRequestHandler: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    ...
    readonly wasm_bindgen_4ac190fa50579fd8___convert__closures_____invoke___wasm_bindgen_4ac190fa50579fd8___JsValue__core_9b3796e30d99ddb7___result__Result_____wasm_bindgen_4ac190fa50579fd8___JsError___true_: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen_4ac190fa50579fd8___convert__closures_____invoke___js_sys_1782145aea5691b7___Function__js_sys_1782145aea5691b7___Function______true_: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen_4ac190fa50579fd8___convert__closures_____invoke___js_sys_1782145aea5691b7___Function_fn_wasm_bindgen_4ac190fa50579fd8___JsValue_____wasm_bindgen_4ac190fa50579fd8___sys__Undefined___js_sys_1782145aea5691b7___Function_fn_wasm_bindgen_4ac190fa50579fd8___JsValue_____wasm_bindgen_4ac190fa50579fd8___sys__Undefined_______true_: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen_4ac190fa50579fd8___convert__closures_____invoke___bool__true_: (a: number, b: number) => number;

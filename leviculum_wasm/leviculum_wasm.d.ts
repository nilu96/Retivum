...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__ha3fbddc58352de1e: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h95c67982f39660c5: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2044653c1ebf4449: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hcf6f1e8ba27e86a8: (a: number, b: number) => number;

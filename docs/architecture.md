...
| Tools | Primary navigation directory for Reticulum logs, Remote provisioning, live Status details, and raw destination Probing; Path management remains planned |
